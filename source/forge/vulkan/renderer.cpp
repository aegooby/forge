...
namespace vulkan
{
renderer::renderer(class window& window) : window(window) { }
...
void renderer::create_swapchain()
{
    if constexpr (__debug__)
    {
        FORGE_EVAL_DISCARD(gpu.getSurfaceCapabilitiesKHR(*surface));
        FORGE_EVAL_DISCARD(gpu.getSurfaceFormatsKHR(*surface));
    }
